<?php
	...
	$strSQLEventMember  = "SELECT e.*,m.*,a.event_memberid, a.md5hash FROM `event_member` a LEFT JOIN `member` m ON a.memberid = m.memberid LEFT JOIN `event` e ON a.eventid = e.eventid ". $whereStr . " ORDER BY m.Name ASC";
...
<html lang="de">
  <head>
    ...
    <title>Login Teilnehmerverwaltung</title>
...
<body>
	<div class="container-fluid">
		...
		<div class="row">
			...
			<h1>Login Teilnehmerverwaltung</h1>
		</div>
			<form action="form_Submit.php" method="post">
				...
				<div class="col-xs-12 col-md-12">
					<button type="submit" class="btn btn-primary col-md-6">Einloggen</button>
				</div>
			</form>
		</div>
		</div>
