<?php
	...
	$strSQLEventMember  = "SELECT e.*,m.*,a.event_memberid,a.signup, a.md5hash FROM `event_member` a LEFT JOIN `member` m ON a.memberid = m.memberid LEFT JOIN `event` e ON a.eventid = e.eventid ". $whereStr . " ORDER BY m.Name ASC";
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<form action="form_Submit.php" method="post">
				...
				<div class="col-xs-12 col-md-12">
					<button type=<?php if($memberid === 0) {echo '"button" onclick="goToList(this.form)"'; } else { echo '"submit"';} ?> class="btn btn-primary col-md-6"><?php $aendern = $memberid === 0 ?  "aktualisieren" :  "bestätigen"; echo $aendern; ?></button>
				</div>
			</form>
		</div>
		</div>
